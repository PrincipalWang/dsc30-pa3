...
class ProteinSynthesisTest {
    ...
    public void totalTest() {
        ...
        CharQueue rna1 = syn.transcribeDNA(dna1);
        String rna = "";
        ...
        CharQueue rna2 = syn.transcribeDNA(dna2);
        rna = "";
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            CharQueue rna3 = syn.transcribeDNA(dna3);
        });
        CharQueue rna4 = syn.transcribeDNA(dna4);
        rna = "";
        ...
        CharQueue pro1 = syn.translateRNA(rna1);
        String pro = "";
        int size = pro1.size();
        ...
        CharQueue pro2 = syn.translateRNA(rna2);
        pro = "";
        size = pro2.size();
        for(int i = 0; i<size; i++){
            pro += pro2.dequeue();
        ...
        CharQueue pro4 = syn.translateRNA(rna4);
        pro = "";
        size = pro4.size();
        for(int i = 0; i<size; i++){
            pro += pro4.dequeue();
